...
This repository provides two trained model weight files for daily three-dimensional temperature and salinity reconstruction in the Northwest Pacific.

The models support the manuscript:
...
Please cite the related manuscript and Zenodo dataset when using these model weights.
